...
-- Note: /opt/oracle/oradata/input_data is the path we defined in docker-compose.yml
CREATE OR REPLACE DIRECTORY source_data_dir AS '/opt/oracle/oradata/input_data';
